  ...
  return (
    <main className="min-h-screen bg-[#03130d] p-6 text-white md:p-8">
      ...
      <section className="mx-auto max-w-4xl rounded-[2rem] border border-white/10 bg-white/[0.07] p-8 shadow-2xl backdrop-blur-xl">
        ...
        <h1 className="mt-4 text-4xl font-black text-white">📸 Photo Updates</h1>
        <p className="mt-4 text-sm font-semibold leading-relaxed text-white/65">Photo, GPS, and Health evidence are now submitted together in the Work Center so the Admin review and Customer timeline stay synced.</p>
