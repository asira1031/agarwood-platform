  ...
  return (
    <main className="min-h-screen bg-[#03130d] p-6 text-white md:p-8">
      ...
      <section className="mx-auto max-w-4xl rounded-[2rem] border border-white/10 bg-white/[0.07] p-8 shadow-2xl backdrop-blur-xl">
        ...
        <h1 className="mt-4 text-4xl font-black text-white">📍 GPS Updates</h1>
        <p className="mt-4 text-sm font-semibold leading-relaxed text-white/65">GPS evidence is now submitted together with Photo and Health in the Work Center so forest-level assignments and QR verification stay consistent.</p>
